...
* 　　　　　　　　　　　　　　　　　　　　　　　　　　　                          　　　　*
*----------------------------------------File Info----------------------------------------*
*文 件 名 ：MilliVoltMeter.c　　　　　　                                                  *
*修改日期 ：2013.11.21  　　　　　　　　　　　　　　                                      *
*版 本 号 ：V1.0　　　　　　　　　　　　　　　　                                          *
*描    述 ：毫伏电压检测模块的终端节点程序，把测得的电压值打包发送给协调器                *
*                                                                                         *
******************************************************************************************/
...
static UART_Format_End2 UART0_Format1;
...
void SerialApp_Init( uint8 task_id )
{
  ...
  UART0_Format.NodeID   = MilliVoltMeter;
  
  UART0_Format1.Header   = 0x40;
  UART0_Format1.Len      = 0x08;
  UART0_Format1.NodeSeq  = 0x01;
  UART0_Format1.NodeID   = MilliVoltMeter;
...
{ 
  ...
  { 
    ...
    temp = temp*25/3;
    adc0_value[0] = temp/100 ;
    adc0_value[1] = temp%100 ;
