...
*修改日期 ：2013.11.21  　　　　　　　　　　　　　　                                      *
*版 本 号 ：V1.0　　　　　　　　　　　　　　　　                                          *
*描    述 ：电压检测模块的终端节点程序，把测得的电压值打包发送给协调器                    *
*                                                                                         *
******************************************************************************************/
...
//static INT8 scaleValue(INT8 adc_value);
...
{ 
  ...
  { 
    ...
    ADC_SINGLE_CONVERSION(ADC_REF_1_25_V | ADC_8_BIT | ADC_AIN0);
    ...
    ADC_SINGLE_CONVERSION(ADC_REF_1_25_V | ADC_8_BIT | ADC_AIN1);
   ...
   // pot0Voltage = scaleValue(adc0_value[0]);
   // pot1Voltage = scaleValue(adc1_value[0]);
